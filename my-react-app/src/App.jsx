...
import { MAISON_AURA_PRODUCTS } from "../components/Products";     // 🌟 Imported Raw Data Array
...
function App() {
  ...
  // Update this function to be passed to Login/Register components
const handleLoginSuccess = () => {
  setIsLoggedIn(true);
  setCurrentView("SHOP"); // Return to shop after login
    };
